      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-center items-center gap-8 lg:px-4">
        ...
        <div className="w-full lg:w-[50%] flex flex-col gap-4 text-white text-center lg:text-left">
          ...
          <p className="text-sm md:text-base leading-6">
            GROW FRONT SOFTWARE PRIVATE LIMITED is deep rooted into the grounds of computation, which is fuelled by strong working environments of advanced computer systems. Only Technology can produce Technology. Our systems include high processing GPUs, and Graphics Drivers, which help us to create the most amazing digital effects, creative designs, logos, and enriched web app graphics. When combined with software like Adobe Suite and MacOS tools, the results are next to none.
          </p>
          <button className="w-[40%] md:w-[20%] mx-auto lg:mx-0 rounded-lg h-10 bg-white text-green-600">
            Get Now
          </button>
        </div>
