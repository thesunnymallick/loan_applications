          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="w-full lg:w-[30%]">
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-white rounded-lg shadow-sm p-4">
                  <h2 className="text-lg text-zinc-800 font-semibold mb-4">
                    Customer Details
                  </h2>
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    {[
                      {
                        label: "File Number",
                        value: customerDetails?.data?.file_no || "N/A",
                      },
                      {
                        label: "Partner ID",
                        value: customerDetails?.data?.partner_id || "N/A",
                      },
                      {
                        label: "Unique ID",
                        value: customerDetails?.data?.unique_id || "N/A",
                      },
                      {
                        label: "First Name",
                        value: customerDetails?.data?.first_name || "N/A",
                      },
                      {
                        label: "Middle Name",
                        value: customerDetails?.data?.middle_name || "N/A",
                      },
                      {
                        label: "Last Name",
                        value: customerDetails?.data?.last_name || "N/A",
                      },
                      {
                        label: "Email",
                        value: customerDetails?.data?.email || "N/A",
                      },
                      {
                        label: "Phone",
                        value: customerDetails?.data?.phone || "N/A",
                      },
                      {
                        label: "Pan",
                        value: customerDetails?.data?.pan || "N/A",
                      },
                      {
                        label: "Aadhar",
                        value: customerDetails?.data?.aadhar || "N/A",
                      },
                      {
                        label: "Residence Address",
                        value:
                          customerDetails?.data?.residence_address || "N/A",
                      },
                      {
                        label: "Residence City",
                        value: customerDetails?.data?.residence_city || "N/A",
                      },
                      {
                        label: "Residence Pincode",
                        value:
                          customerDetails?.data?.residence_pincode || "N/A",
                      },
                      {
                        label: "Residence State",
                        value: customerDetails?.data?.residence_state || "N/A",
                      },
                      {
                        label: "Office Address",
                        value: customerDetails?.data?.office_address || "N/A",
                      },
                      {
                        label: "Office City",
                        value: customerDetails?.data?.office_city || "N/A",
                      },
                      {
                        label: "Office Pincode",
                        value: customerDetails?.data?.office_pincode || "N/A",
                      },
                      {
                        label: "Office State",
                        value: customerDetails?.data?.office_state || "N/A",
                      },
                      {
                        label: "Status",
                        value: customerDetails?.data?.status || "N/A",
                      },
                    ].map(({ label, value }, idx) => (
