...
import { uploadInsuranceDoc } from "../../api/partner/InsuranceApi";
...
const handleUpload = (file, key, isPdf) => {
 ...
 const requiredDocuments= [
    { title: "Aadhar Card Front", imageKey: "aadhar_card_front", passwordKey: "aadhar_card_front_password" },
    { title: "Aadhar Card Back", imageKey: "aadhar_card_back", passwordKey: "aadhar_card_back_password" },
    { title: "Pan Card Image", imageKey: "pan_card", passwordKey: "pan_card_password" },
    { title: "Passport Photo", imageKey: "passport", passwordKey: "passport_password" },
    { title: "RC", imageKey: "rc", isPdf: true, passwordKey: "rc_photo_password" },
  ...
  return (
    ...
    <div className="flex items-center gap-2">
      <Link to={"/our-panels/insurancePanel"} className="text-zinc-800 font-semibold text-xl">
        <FaArrowLeft />
      </Link>
      ...
      <div className="w-full md:w-[30%]">
        <div className="flex flex-col gap-4">
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h2 className="text-zinc-800 font-bold">
                <span>{customerDetails?.data?.loan_type}</span> Of Rs <span>{customerDetails?.data?.loan_amount} </span> <span>{customerDetails?.data?.tenure}</span>
              </h2>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 p-4 text-sm">
              {/* Column 1 */}
